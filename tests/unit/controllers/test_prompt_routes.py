...
from src.controllers.rest.prompt_routes import router
...
class TestCreateInitialPrompt:
    ...
    @patch("src.controllers.rest.prompt_routes.get_container")
    @patch("src.controllers.rest.prompt_routes.get_async_session")
